...
/datum/species/halforc
	...
	specstats = list("strength" = 1, "perception" = -2, "intelligence" = -2, "constitution" = 2, "endurance" = 2, "speed" = 0, "fortune" = -1)
	specstats_f = list("strength" = 1, "perception" = -2, "intelligence" = -1, "constitution" = 1, "endurance" = 2, "speed" = 0, "fortune" = -1)
